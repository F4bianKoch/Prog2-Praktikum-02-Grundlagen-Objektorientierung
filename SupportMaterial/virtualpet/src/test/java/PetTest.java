...
public class PetTest{
  ...
  @Test  public void testIsSadHappy(){    assertFalse("new pet is not sad", pet.isSad());    assertFalse("new pet is not happy", pet.isHappy());
    pet.changeHappiness(-10);
    assertTrue("pet with happinesss value of " + pet.getHappiness() + " is sad", pet.isSad());    assertFalse("pet with happinesss value of " + pet.getHappiness() + " is not happy", pet.isHappy());
    pet.changeHappiness(+10);
    assertFalse("pet with happinesss value of " + pet.getHappiness() + " is not sad", pet.isSad());    assertTrue("pet with happinesss value of " + pet.getHappiness() + " is happy", pet.isHappy());
  }
